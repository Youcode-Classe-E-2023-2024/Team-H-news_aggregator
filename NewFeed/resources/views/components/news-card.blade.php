<a href="#" target="_blank">
    <div class='w-[350px] h-[300px] relative hover:scale-[110%]'>
        <img src="{{asset('images/news.webp')}}" alt={title} class='object-cover w-full h-full absolute top-0 left-0 z-1' />
        <div class='w-full h-full flex flex-col relative z-2 items-center justify-end p-3 bg-gradient-to-b from-transparent to-black font-thin'>
            ...
            <img src="{{'images/heart1.png'}}" id="icon-heart" class="" alt="" srcset="" style="position: relative;background: white;bottom: 90%;left: 45%;border-radius: 15px;padding: 5px">
        </div>
    </div>
</a>
