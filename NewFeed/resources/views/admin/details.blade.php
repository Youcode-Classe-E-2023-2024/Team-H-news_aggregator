                            ...
                            <div class="featured-image">
                                ...
                                <div class="post-header">
                                    ...
                                    <div class="post-meta-info d-flex justify-content-between">
                                        ...
                                        <div class="media">
                                            <img src="../src/assets/img/profile-12.jpg" alt="profile">
...
&lt;/button&gt; </pre>
                                ...
                                <img src="../src/assets/img/lightbox-3.jpg" alt="image-1" class="full-width img-fluid mt-4 mb-5">
                                ...
                                <div class="text-center mb-5">
                                    <img src="../src/assets/img/slider-3.jpg" alt="image-1" class="img-fluid">
                                </div>
                                ...
                                <div class="post-dynamic-meta mt-5 mb-5">
                                    ...
                                    <div class="avatar--group mb-2">
                                        <div class="avatar avatar-sm m-0">
                                            <img alt="avatar" src="../src/assets/img/profile-16.jpg" class="rounded-circle">
                                        </div>
                                        <div class="avatar avatar-sm">
                                            <img alt="avatar" src="../src/assets/img/delete-user-4.jpg" class="rounded-circle">
                                        </div>
                                        <div class="avatar avatar-sm">
                                            <img alt="avatar" src="../src/assets/img/profile-5.jpg" class="rounded-circle">
                                        </div>
                                        <div class="avatar avatar-sm">
                                ...
                                <div class="post-comments">
                                    ...
                                    <div class="media mb-5 pb-5 primary-comment">
                                        ...
                                        <div class="avatar me-4">
                                            <img alt="avatar" src="../src/assets/img/profile-2.jpg" class="rounded-circle" />
                                        </div>
                                        <div class="media-body">
                                            ...
                                            <div class="media mb-4 mt-4">
                                                ...
                                                <div class="avatar me-4">
                                                    <img alt="avatar" src="../src/assets/img/profile-3.jpg" class="rounded-circle" />
                                                </div>
                                                <div class="media-body">
                                            ...
                                            <div class="media mt-4">
                                                ...
                                                <div class="avatar me-4">
                                                    <img alt="avatar" src="../src/assets/img/profile-25.jpg" class="rounded-circle" />
                                                </div>
                                                <div class="media-body">
                                    ...
                                    <div class="media mb-5 pb-5 primary-comment">
                                        ...
                                        <div class="avatar me-4">
                                            <img alt="avatar" src="../src/assets/img/profile-12.jpg" class="rounded-circle" />
                                        </div>
                                        <div class="media-body">
                                    ...
                                    <div class="media mb-5 pb-5 primary-comment">
                                        ...
                                        <div class="avatar me-4">
                                            <img alt="avatar" src="../src/assets/img/profile-9.jpg" class="rounded-circle" />
                                        </div>
                                        <div class="media-body">
